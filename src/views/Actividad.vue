  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Metodología viaje del usuario
        p.mb-4 Fortalecer los aspectos conceptuales y prácticos sobre Aplicaciones móviles híbridas, con base en los temas estudiados en el componente formativo.
